...
#define SIZE_SHA3_256 256
#define MS2XL_BASEADDR_SHA3_256 0x43C20000
#define MDLEN_256 32
#define SHAKE_OUT_256 0
#define SIZE_OUTPUT_SHA3_256 SIZE_SHA3_256 / 8
#define	SIZE_BLOCK_SHA3_256 (1600 - (2*SIZE_SHA3_256))

#define SIZE_SHA3_512 512
#define MS2XL_BASEADDR_SHA3_512 0x43C30000
#define MDLEN_512 64
#define SHAKE_OUT_512 0
#define SIZE_OUTPUT_SHA3_512 SIZE_SHA3_512 / 8
#define	SIZE_BLOCK_SHA3_512 (1600 - (2*SIZE_SHA3_512))
