/****************************************************************************************/
/*
 *  IMSE.CNM_SPIR-HwSec_puf4r4_2.2: puf4r4.h  
 *
...
#ifndef PUF4R4_H_INCLUDED
#define PUF4R4_H_INCLUDED
...
//#define IP_OPER
 ...
 #define MN_CMPS      128*Nx*Ny   // Max number of comparisons
 #define MN_BITS  BPC*128*Nx*Ny   // Max number of bits
 #define MN_REGS    BPC*4*Nx*Ny   // Max number of registers
 #define ML_KEY            1024   // Max length Key  
...
/****************************************************************************************/
  ...
  int PUF_applyChallenges(MMIO_WINDOW* puf, unsigned int config, int cmps, int DBG);
...
/************************************ Standalone macros *********************************/
  ...
  #define PUF4R4_mReadReg(BaseAddress, RegOffset) \
    Xil_In32((BaseAddress) + (RegOffset))

  #define PUF4R4_mWriteReg(BaseAddress, RegOffset, Data) \
