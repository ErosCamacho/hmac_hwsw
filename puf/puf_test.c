/******************************************************************************/
/*
 *  IMSE.CNM_SPIRS-HwSec_puf4r4_2.2: puf_test.c for PUF4R4_2.2  32/64-bits
 *
...
int N_CMPS     = 1024;      //    Number of comparisons
int E_CMPS     = 102;       //    Number of discarded comparisons
...
int K_bits     = 512;      // -k Number of bits of KEY
      ...
      if(argv[arg][0] == '-') {
         if(argv[arg][1] == 'h') {
           ...
           return SUCCESS;  
            ...
            if(N_CMPS>256*Nx*Ny) N_CMPS=256*Nx*Ny;
